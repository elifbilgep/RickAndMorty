...
extension SearchViewController: SearchViewControllerProtocol {
    ...
    func configureCollectionView() {
        ...
        collectionView.register(UINib(nibName: Nibs.characterCell,
                                      bundle: Bundle(for: CharacterColletionViewCell.self)),
                                forCellWithReuseIdentifier: CharacterColletionViewCell.cellIdentifier)
...
extension SearchViewController: UICollectionViewDelegate,
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: CharacterColletionViewCell.cellIdentifier, for: indexPath)
